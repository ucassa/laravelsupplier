...
<div class="max-w-[720px] mx-auto py-32 sm:py-8 lg:py-16">
 <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border px-6 py-6">
   {{-- Form --}}
   <form action="{{ route('user.update', ['user' => $user->id_user]) }}" method="POST">
     @csrf
     @method('put')
     <div class="border-b border-gray-900/10 pb-12">
       ...
       <div class="mt-5 col-span-full gap-y-8">
         <label for="nama_user" class="block text-sm/6 font-medium text-gray-900">Name</label>
         <div class="mt-2">
       ...
       <div class="mt-5 col-span-full gap-y-8">
         <label for="alamat_user" class="block text-sm/6 font-medium text-gray-900">Address</label>
         <div class="mt-2">
           <textarea id="alamat_user" name="alamat_user" rows="3" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">{{ old('alamat_user', $user->alamat_user) }}</textarea>
         </div>
       </div>


       <div class="mt-5 col-span-full gap-y-8">
         <label for="telepon_user" class="block text-sm/6 font-medium text-gray-900">Phone Number</label>
         <div class="mt-2">
           <input id="telepon_user" name="telepon_user" type="text" value="{{ old('telepon_user', $user->telepon_user) }}" class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
         </div>
       </div>
     </div>
